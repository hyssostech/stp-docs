...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) -> [MapOperationExtEventArgs](./stpsdk.mapoperationexteventargs)
...
### **MapOperationExtEventArgs(String, Location, Dictionary&lt;String, String&gt;)**

```csharp
public MapOperationExtEventArgs(string operation, Location location, Dictionary<string, string> properties)
```
