...
```csharp
public class StpException : System.Exception, System.Runtime.Serialization.ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) -> [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) -> [StpException](./stpsdk.stpexception)<br>
...
### **StpException(String, Exception)**

```csharp
public StpException(string message, Exception inner)
```
