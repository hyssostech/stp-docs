...
```csharp
public class StpTaskOrgUnit : StpSymbol, IStpObject, System.ComponentModel.INotifyPropertyChanged
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) -> [StpObject](./stpsdk.stpobject) -> [StpItem](./stpsdk.stpitem) -> [StpSymbol](./stpsdk.stpsymbol) -> [StpTaskOrgUnit](./stpsdk.stptaskorgunit)<br>
...
```csharp
public override string SymbolDesignation { get; }
```
